...
call dnvm install 1.0.0-rc2-16453 -u -r clr -arch x86
call dnvm install 1.0.0-rc2-16453 -u -r clr -arch x64
call dnvm install 1.0.0-rc2-16453 -u -r coreclr -arch x86
call dnvm install 1.0.0-rc2-16453 -u -r coreclr -arch x64
...
call dnvm use 1.0.0-rc2-16453 -r coreclr -arch x86
...
setlocal
call dnvm use 1.0.0-rc2-16453 -r %~2 -arch x86
pushd tests\%~1
if "%~2" == "" (
  call dnx test
) else (
...
setlocal
call dnvm use 1.0.0-rc2-16453 -r %~2 -arch %~3
